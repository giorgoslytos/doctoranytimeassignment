if ($('.main-content')) {
  ...
  function App() {
    return {
      ...
      characterHandler: function (event) {
        $('.modal').show();
  ...
  const app = new App();
  $chevrones.click(app.chevronHandler.bind(app));
  $modal.click(app.clearModal.bind(app));
  app.fetchURLParams();
}
